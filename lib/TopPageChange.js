...
var TopChangePage = function (_React$Component) {
  _inherits(TopChangePage, _React$Component);
  ...
  function TopChangePage() {
    ...
    _classCallCheck(this, TopChangePage);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TopChangePage.__proto__ || Object.getPrototypeOf(TopChangePage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      currentNum: 1
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(TopChangePage, [{
    key: 'render',
